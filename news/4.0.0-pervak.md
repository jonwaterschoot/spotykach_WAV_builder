...
Walked on an Android phone: a pack page with its cover and its description, the licence terms that come with it, and the file rows — preview, edit, add — with the player docked at the bottom while something plays.

<div style="display:flex;gap:0.75rem;flex-wrap:wrap;margin:2.5rem 0;">
<img src="images/WAVbuilder_SampleBrowser_mobile01.jpg" alt="A sample pack page on a phone" style="flex:1 1 30%;min-width:150px;margin:0;" />
<img src="images/WAVbuilder_SampleBrowser_mobile02.jpg" alt="A pack's licence terms on a phone" style="flex:1 1 30%;min-width:150px;margin:0;" />
<img src="images/WAVbuilder_SampleBrowser_mobile03.jpg" alt="Sample rows on a phone, with a file playing" style="flex:1 1 30%;min-width:150px;margin:0;" />
</div>
